...
class Task extends Component {
  ...
  render() {
    const { id, title, completed, toggleTaskCompletion, deleteTask, createdAt } = this.props;
    ...
    return (
      <span className={`task ${completed ? 'completed' : ''} ${isEditing ? 'editing' : ''}`}>
        <div className="view">
          <input className="toggle" type="checkbox" checked={completed} onChange={() => toggleTaskCompletion(id)} />
